...
CreateClientConVar( "voicebalancer_samples", 300, true, true, "How many historic samples to store", 33, 1200 )
...
local function populatePanel( panel )
    ...
    panel:Help( "Sample Size determines how many historic samples to keep. This affects the length of the line graph and the averaging of the percentage.")
